...
export class SkillsComponent {
  ...
  public hardSkills: Skill[] = [
    ...
    { key: "AngularJs", currentValue: 0, value: 60 } as Skill,
    { key: "Angular 2+", currentValue: 0, value: 80 } as Skill,
    { key: "ReactJs", currentValue: 0, value: 90 } as Skill,
    { key: "Python", currentValue: 0, value: 85 } as Skill,
    { key: "Ruby", currentValue: 0, value: 40 } as Skill,
    { key: "Ansible", currentValue: 0, value: 70 } as Skill,
    { key: "Bash", currentValue: 0, value: 50 } as Skill,
